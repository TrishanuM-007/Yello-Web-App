            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex flex-col items-center gap-4 shrink-0">
                ...
                <div 
                  ...
                  className="w-32 h-32 rounded-full border-2 border-dashed border-gray-600 bg-gray-50 dark:bg-[#0F172A] hover:border-yellow-400 flex flex-col items-center justify-center cursor-pointer transition-colors overflow-hidden group"
                >
                  {imageUrl ? (
                    <img src={imageUrl} alt="Preview" className="w-full h-full object-cover" />
                  ) : (
                    <>
                      <ImageIcon size={24} className="text-gray-500 dark:text-gray-400 group-hover:text-yellow-400 mb-2 transition-colors" />
                      <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 group-hover:text-yellow-400 uppercase tracking-wider">Upload</span>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-gray-50 dark:bg-[#0F172A] border border-gray-300 dark:border-gray-700 rounded-xl text-sm outline-none focus:border-yellow-400 text-gray-900 dark:text-white transition-colors resize-none"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <input 
                  ...
                  className="w-full md:w-1/2 px-4 py-3 bg-gray-50 dark:bg-[#0F172A] border border-gray-300 dark:border-gray-700 rounded-xl text-sm outline-none focus:border-yellow-400 text-gray-900 dark:text-white transition-colors"
                />
